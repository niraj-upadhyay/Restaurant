    ...
    if(isset($_POST['submit']))
    {
        ...
        if($cnpass==$npass)
        {
            ...
            if(mysqli_num_rows($res)==1)
            {
                ...
                $hash=password_verify($opass,$row['password']);
                if($hash)
                {
                    $hash2=password_hash($npass,PASSWORD_DEFAULT);
                    $sql="UPDATE `user_db` SET `password` = '$hash2' WHERE `user_db`.`email` = '$email'";
                    ...
                    {
                        $error[] = 'Password is not update try again!';
                    }
                }
                else
                {
                    $error[] = 'Incorrect your old password!';
                }
            }
            else
            {
                        ...
                        <div class="col-md-6 col-lg-7 d-flex align-items-center">
                            <div class="card-body p-4 p-lg-5 text-black">
                                ...
                                <form action="" method="post">
                                    ...
                                    <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Reset Your Password
                                    </h5>
                                    ...
                                    <div class="form-outline mb-4">
                                        ...
                                        <input type="password" id="form2Example27" name="npass"
                                            class="form-control form-control-lg" />
                                    </div>
                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="form2Example27">Confirm Password</label>
                                        <input type="password" id="form2Example27" name="cnpass"
                                            class="form-control form-control-lg" />
                                    </div>
                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="form2Example27">Old Password</label>
                                        <input type="password" id="form2Example27" name="opass"
                                            class="form-control form-control-lg" />
                                    </div>
                                    ...
                                    <a href="termcond.php" class="small text-muted">Privacy policy</a>
                                </form>
